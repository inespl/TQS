...
public class Dip {
    ...
    static final int NONUMBERS = 5;
    static final int NOSTARS = 2;
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (NONUMBERS == arrayOfNumbers.length && NOSTARS == arrayOfStarts.length) {
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < 5; i++) {
            int candidate = generator.nextInt(MAXRANGE -1) + 1;
